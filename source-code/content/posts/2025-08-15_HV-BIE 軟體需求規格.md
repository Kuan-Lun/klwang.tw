+++
title = "HV-BIE 軟體需求規格（SRS）"
slug = "hv-bie-srs"
date = 2025-08-15

[taxonomies]
tags = ["SRS", "軟體需求規格", "Python", "HentaiVerse", "專案文件"]
authors = ["王冠倫"]
+++

本文為 HV Battle Intelligence Extractor（HV-BIE）專案的軟體需求規格（Software Requirements Specification, SRS）。
文件依循 ISO/IEC/IEEE 29148:2018 之結構與精神編排，作為練習撰寫 SRS 的案例，後續將撰寫對應的技術規格並完成程式實作。
